	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">摊位名称</div>
					<div  class="info_text" >{{detail.tanweimingcheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">摊位地址</div>
					<div  class="info_text" >{{detail.tanweidizhi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">租金元/月</div>
					<div  class="info_text" >{{detail.zujin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">租赁月数</div>
					<div  class="info_text" >{{detail.zulinyueshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">经营范围</div>
					<div  class="info_text" >{{detail.jingyingfanwei}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">产品信息</div>
					<div  class="info_text" >{{detail.chanpinxinxi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('ruzhushenqing','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('ruzhushenqing','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('ruzhushenqing','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('ruzhushenqing','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
