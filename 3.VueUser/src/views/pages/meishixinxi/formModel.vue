	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">人均消费</div>
					<div  class="info_text" >{{detail.renjunxiaofei}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">美食地址</div>
					<div  class="info_text" >{{detail.meishidizhi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('meishixinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
