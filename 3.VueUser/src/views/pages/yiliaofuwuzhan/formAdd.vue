...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"76%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="8">
					<el-form-item label="服务站名称" prop="fuwuzhanmingcheng">
						<el-input class="list_inp" v-model="form.fuwuzhanmingcheng" placeholder="服务站名称"
							 type="text" 							:readonly="!isAdd||disabledForm.fuwuzhanmingcheng?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="服务站地址" prop="fuwuzhandizhi">
						<el-input class="list_inp" v-model="form.fuwuzhandizhi" placeholder="服务站地址"
							 type="text" 							:readonly="!isAdd||disabledForm.fuwuzhandizhi?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="服务范围" prop="fuwufanwei">
						<el-input v-model="form.fuwufanwei" placeholder="服务范围" type="textarea"
						:readonly="!isAdd||disabledForm.fuwufanwei?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='fuwuzhanmingcheng'){
					form.value.fuwuzhanmingcheng = row[x];
					disabledForm.value.fuwuzhanmingcheng = true;
					continue;
				}
				if(x=='fengmian'){
				...
				if(x=='fuwuzhandizhi'){
					form.value.fuwuzhandizhi = row[x];
					disabledForm.value.fuwuzhandizhi = true;
					continue;
				}
				if(x=='lianxifangshi'){
				...
				if(x=='fuwufanwei'){
					form.value.fuwufanwei = row[x];
					disabledForm.value.fuwufanwei = true;
					continue;
				}
			}
			if(row){
