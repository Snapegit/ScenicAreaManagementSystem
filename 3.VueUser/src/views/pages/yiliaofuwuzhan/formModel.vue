			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						{{detail.fuwuzhanmingcheng}}
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">服务站地址</div>
					<div  class="info_text" >{{detail.fuwuzhandizhi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">服务时间</div>
					<div  class="info_text" >{{detail.fuwushijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">服务范围</div>
					<div  class="info_text" >{{detail.fuwufanwei}}</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('yiliaofuwuzhan','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('yiliaofuwuzhan','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('yiliaofuwuzhan','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.fuwuzhanmingcheng
