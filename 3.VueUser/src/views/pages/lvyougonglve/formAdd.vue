			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="攻略详情" prop="gonglvexiangqing">
						<editor class="list_editor" :value="form.gonglvexiangqing" placeholder="请输入攻略详情" :readonly="!isAdd||disabledForm.gonglvexiangqing?true:false"
							@change="(e)=>editorChange(e,'gonglvexiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.gonglvexiangqing = res.data.data.gonglvexiangqing.replace(reg,'../../../cl65596292/file');
