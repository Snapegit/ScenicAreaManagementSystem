	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">行程路线</div>
					<div  class="info_text" >{{detail.xingchengluxian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">出行方式</div>
					<div  class="info_text" >{{detail.chuxingfangshi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">酒店推荐</div>
					<div  class="info_text" >{{detail.jiudiantuijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">美食推荐</div>
					<div  class="info_text" >{{detail.meishituijian}}</div>
				</div>
				<div class="btn_view">
		...
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="攻略详情" name="first">
				<div v-html="detail.gonglvexiangqing"></div>
			</el-tab-pane>
            <el-tab-pane label="地图" name="mapActive">
				<iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no src="https://www.amap.com/" height="600px" width="100%"></iframe>
            </el-tab-pane>
		</el-tabs>
	</div>
</template>
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.gonglvebiaoti
