		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			<div class="search_view">
				...
				<div class="search_box">
					<el-input class="search_inp" v-model="searchQuery.gonglvebiaoti" placeholder="攻略标题"
						clearable>
					</el-input>
				</div>
			</div>
...
<script setup>
	...
	const getList = () => {
		...
		if(searchQuery.value.gonglvebiaoti&&searchQuery.value.gonglvebiaoti!=''){
			params.gonglvebiaoti = '%' + searchQuery.value.gonglvebiaoti + '%'
		}
		context?.$http({
