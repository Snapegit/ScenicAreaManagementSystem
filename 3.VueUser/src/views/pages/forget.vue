	...
	<div>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">基于web的景区管理系统{{pageType==1?'找回密码':pageType==2?'输入密保':'重置密码'}}</div>
				<div class="tab_line">
					<div class="line"></div>
					<div class="num_line">
...
<style lang="scss" scoped>
	.forget_view {
		...
		background: url(http://clfile.zggen.cn/20231215/1fb961fae2f94d149038648724b01b3e.jpg);
		display: flex;
		min-height: 100vh;
