	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"76%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="门票链接" prop="menpiaolianjie">
						<el-input class="list_inp" v-model="form.menpiaolianjie" placeholder="门票链接"
							 type="text" 							:readonly="!isAdd||disabledForm.menpiaolianjie?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="景点介绍" prop="jingdianjieshao">
						<editor class="list_editor" :value="form.jingdianjieshao" placeholder="请输入景点介绍" :readonly="!isAdd||disabledForm.jingdianjieshao?true:false"
							@change="(e)=>editorChange(e,'jingdianjieshao')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.jingdianjieshao = res.data.data.jingdianjieshao.replace(reg,'../../../cl65596292/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='menpiaolianjie'){
					form.value.menpiaolianjie = row[x];
					disabledForm.value.menpiaolianjie = true;
					continue;
				}
