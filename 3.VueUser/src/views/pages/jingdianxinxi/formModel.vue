	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">门票链接</div>
					<div class="info_link" @click="linkOthers(detail.menpiaolianjie)" >{{detail.menpiaolianjie}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">路线推荐</div>
					<div  class="info_text" >{{detail.luxiantuijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'购买')" @click="menpiaogoumaionAcross('购买','menpiaogoumai','','','')" type="warning">购买</el-button>
