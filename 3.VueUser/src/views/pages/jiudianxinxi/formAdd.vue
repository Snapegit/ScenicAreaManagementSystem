			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="酒店类型" prop="jiudianleixing">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.jiudianleixing?true:false"
							v-model="form.jiudianleixing" 
							placeholder="请选择酒店类型"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in jiudianleixingLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="24">
					<el-form-item label="房内设施" prop="fangneisheshi">
						<editor class="list_editor" :value="form.fangneisheshi" placeholder="请输入房内设施" :readonly="!isAdd||disabledForm.fangneisheshi?true:false"
							@change="(e)=>editorChange(e,'fangneisheshi')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fangneisheshi = res.data.data.fangneisheshi.replace(reg,'../../../cl65596292/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			...
			jiudianleixingLists.value = res.data.data
		})
