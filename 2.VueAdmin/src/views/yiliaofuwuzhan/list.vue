	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.fuwuzhanmingcheng" placeholder="服务站名称"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('yiliaofuwuzhan','新增')">新增</el-button>
					<el-button  v-if=" btnAuth('yiliaofuwuzhan','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">详情</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('yiliaofuwuzhan','修改')">修改</el-button>
					<el-button type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('yiliaofuwuzhan','删除')">删除</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				ref="table"
				v-if="btnAuth('yiliaofuwuzhan','查看')"
				:data="list"
				...
				<el-table-column
					 ...
					 align="left" 
					 header-align="left"
					 prop="fuwuzhanmingcheng"
					label="服务站名称">
					<template #default="scope">
						{{scope.row.fuwuzhanmingcheng}}
					</template>
				</el-table-column>
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button type="info" v-if=" btnAuth('yiliaofuwuzhan','查看')" @click="infoClick(scope.row.id)">详情</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
	...
	//基础信息
	const tableName = 'yiliaofuwuzhan'
	const formName = '医疗服务站'
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.fuwuzhanmingcheng&&searchQuery.value.fuwuzhanmingcheng!=''){
			params['fuwuzhanmingcheng'] = '%' + searchQuery.value.fuwuzhanmingcheng + '%'
		}
		context?.$http({
			url: `${tableName}/page`,
			method: 'get',
