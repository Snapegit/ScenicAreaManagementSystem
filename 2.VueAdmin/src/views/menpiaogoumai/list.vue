...
<template>
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button type="warning" @click="echartClick1" v-if="btnAuth('menpiaogoumai','景点参观人数')">景点参观人数</el-button>
				</div>
			</div>
			<br>
			<el-table
		...
		<!-- 统计图弹窗 -->
		<el-dialog v-model="echartVisible" :title="'景点参观人数'" width="70%">
...
<script setup>
	...
	const echartClick1 = ()=>{
		...
		nextTick(()=>{
			...
			context?.$http({
				url: `menpiaogoumai/value/jingdianmingcheng/shuliang`,
				method: 'get'
			}).then(res=>{
				...
				for(let i=0;i<obj.length;i++){
				    xAxis.push(obj[i].jingdianmingcheng);
				    yAxis.push(parseFloat((obj[i].total)));
				    pArray.push({
				        value: parseFloat((obj[i].total)),
				        name: obj[i].jingdianmingcheng
				    })
				}
				var option = {};
                option = {
