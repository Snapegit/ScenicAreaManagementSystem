...
<template>
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button type="warning" @click="echartClick1" v-if="btnAuth('shangpinxinxi','库存统计')">库存统计</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				<el-table-column label="商品图片" width="120" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('shangpinxinxi','购买')" type="success" @click="shangpingoumaiCrossAddOrUpdateHandler(scope.row,'cross','','','')">购买</el-button>
		...
		<shangpingoumaiFormModel ref="shangpingoumaiFormModelRef" @formModelChange="formModelChange"></shangpingoumaiFormModel>
	</div>
</template>
<script setup>
	...
	import shangpingoumaiFormModel from '@/views/shangpingoumai/formModel'
	const shangpingoumaiFormModelRef = ref(null)
    const shangpingoumaiCrossAddOrUpdateHandler = (row,type,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			shangpingoumaiFormModelRef.value.init(row.id,'cross','购买',row,'shangpinxinxi',statusColumnName,tips,statusColumnValue)
		})
    }
	//初始化
	const init = () => {
