		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="酒店推荐" prop="jiudiantuijian">
							<el-input class="list_inp" v-model="form.jiudiantuijian" placeholder="酒店推荐"
								 type="text" 								:readonly="!isAdd||disabledForm.jiudiantuijian?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="美食推荐" prop="meishituijian">
							<el-input class="list_inp" v-model="form.meishituijian" placeholder="美食推荐"
								 type="text" 								:readonly="!isAdd||disabledForm.meishituijian?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="行程路线" prop="xingchengluxian">
							<el-input v-model="form.xingchengluxian" placeholder="行程路线" type="textarea"
							:readonly="!isAdd||disabledForm.xingchengluxian?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="攻略详情" prop="gonglvexiangqing">
							<editor :value="form.gonglvexiangqing" placeholder="请输入攻略详情" :readonly="!isAdd||disabledForm.gonglvexiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'gonglvexiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.gonglvexiangqing = res.data.data.gonglvexiangqing?(res.data.data.gonglvexiangqing.replace(reg,'../../../cl65596292/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xingchengluxian'){
					form.value.xingchengluxian = row[x];
					disabledForm.value.xingchengluxian = true;
					continue;
				}
				if(x=='qidian'){
				...
				if(x=='gonglvexiangqing'){
					form.value.gonglvexiangqing = row[x];
					disabledForm.value.gonglvexiangqing = true;
					continue;
				}
				if(x=='jiudiantuijian'){
					form.value.jiudiantuijian = row[x];
					disabledForm.value.jiudiantuijian = true;
					continue;
				}
				if(x=='meishituijian'){
					form.value.meishituijian = row[x];
					disabledForm.value.meishituijian = true;
					continue;
				}
				if(x=='shipin'){
