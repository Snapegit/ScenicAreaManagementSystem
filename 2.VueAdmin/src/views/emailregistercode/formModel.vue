				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="邮箱" prop="email">
							<el-input class="list_inp" v-model="form.email" placeholder="邮箱"
								 type="text" 								:readonly="!isAdd||disabledForm.email?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="验证码" prop="code">
							<el-input class="list_inp" v-model="form.code" placeholder="验证码"
								 type="text" 								:readonly="!isAdd||disabledForm.code?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='email'){
					form.value.email = row[x];
					disabledForm.value.email = true;
					continue;
				}
				if(x=='role'){
				...
				if(x=='code'){
					form.value.code = row[x];
					disabledForm.value.code = true;
					continue;
				}
			}
			if(row){
